        ...
        >
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <div className="flex flex-col sm:flex-1">
              ...
              <input
                ...
                className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-golden-400 focus:outline-none"
              />
            </div>
          </div>
          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="flex flex-col sm:flex-1">
              ...
              <textarea
                ...
                className="text-[16px] py-2 bg-transparent border-2 border-golden-400 focus:outline-none px-2 rounded-md"
                rows={10}
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div class="flex items-center justify-center w-full">
              <label
                for="dropzone-file"
                class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 dark:border-gray-700 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
              >
          ...
          <button className="bg-gold-gradient shadow-lg border-2 border-golden-400 font-semibold text-xl transition-all duration-300 py-2 px-4 rounded-md text-warm-white w-[280px] mx-auto lg:w-[640px] my-4 btn-hover">
