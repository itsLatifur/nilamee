                  ...
                  <tr key={element._id}>
                    ...
                    <td className="py-2 px-4 flex space-x-2">
                      <Link
                        ...
                        className="bg-gold-gradient whitestone:bg-amber-600 btn-hover text-warm-white whitestone:text-white py-1 px-3 rounded-md border-2 border-golden-400 whitestone:border-amber-500 shadow-lg transition-all duration-300 whitestone:text-white"
                      >
                        View
                      </Link>
                      <button
