                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="flex items-center py-4 justify-center gap-3">
                      <button
                        className="bg-gold-gradient text-warm-white whitestone:text-white py-1 px-3 rounded border-2 border-golden-400 whitestone:border-gray-600 shadow-lg transition-all duration-300 btn-hover"
          ...
          <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
            ...
            <form className="flex flex-col gap-5 my-5">
              ...
              <div>
                <button
                  type="button"
                  className="bg-gold-gradient whitestone:bg-amber-600 flex justify-center w-full py-2 rounded-md text-warm-white whitestone:text-white font-semibold text-xl transition-all duration-300 shadow-lg border-2 border-golden-400 whitestone:border-amber-500 btn-hover"
