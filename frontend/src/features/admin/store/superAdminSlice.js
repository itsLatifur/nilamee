...
export const getMonthlyRevenue = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(API_ENDPOINTS.ADMIN.MONTHLY_REVENUE, {
...
export const getAllPaymentProofs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(API_ENDPOINTS.ADMIN.PAYMENT_PROOFS, {
      withCredentials: true,
    });
    dispatch(
...
export const deletePaymentProof = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(API_ENDPOINTS.ADMIN.DELETE_PROOF(id), {
      withCredentials: true,
    });
...
export const getSinglePaymentProofDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      API_ENDPOINTS.ADMIN.PAYMENT_PROOF_DETAIL(id),
      { withCredentials: true }
    );
    dispatch(
...
export const updatePaymentProof = (id, status, amount) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      API_ENDPOINTS.ADMIN.UPDATE_PROOF(id),
      { status, amount },
...
export const deleteAuctionItem = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      API_ENDPOINTS.ADMIN.DELETE_AUCTION(id),
      { withCredentials: true }
    );
