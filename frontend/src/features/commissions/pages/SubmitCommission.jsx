import { postCommissionProof } from "../store/commissionSlice";
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={7}
                className="text-[16px] py-2 bg-transparent border-[1px] rounded-md px-1 border-golden-400 whitestone:border-white/30 focus:outline-none"
              />
            </div>
            <button
