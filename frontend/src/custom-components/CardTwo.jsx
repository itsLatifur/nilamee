          ...
          <form className="flex flex-col gap-5 my-5">
            <div className="flex flex-col gap-3">
              ...
              <DatePicker
                ...
                className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-golden-400 whitestone:border-b-gray-400 focus:outline-none w-full text-warm-white"
              />
            </div>
            <div className="flex flex-col gap-3">
              <label className="text-[16px] text-golden-300 whitestone:text-gray-900">
            ...
            <div>
              <button
                type="button"
                className="bg-gold-gradient whitestone:bg-amber-600 btn-hover flex justify-center w-full py-2 rounded-md text-warm-white whitestone:text-white font-semibold text-xl transition-all duration-300 border-2 border-golden-400 whitestone:border-amber-500 shadow-lg whitestone:text-white"
