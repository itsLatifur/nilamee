...
const Drawer = ({ setOpenDrawer, openDrawer, id }) => {
  ...
  return (
    ...
    >
      <div className="republish-modal bg-gradient-to-br from-burgundy-950/95 to-golden-950/90 dark:from-black/95 dark:to-gray-950/90 royal:from-burgundy-950/95 royal:to-golden-950/90 whitestone:bg-white backdrop-blur-sm whitestone:backdrop-blur-none h-fit transition-all duration-300 w-full border-t-4 border-golden-400 dark:border-golden-500 royal:border-golden-400 whitestone:border-blue-500 whitestone:shadow-xl">
        <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
          <h3 className="text-golden-500 whitestone:text-blue-600 text-3xl font-semibold text-center mb-1">
            Republish Auction
          </h3>
          ...
          <form className="flex flex-col gap-5 my-5">
            <div className="flex flex-col gap-3">
              ...
              <DatePicker
                ...
                className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-golden-400 whitestone:border-b-blue-400 focus:outline-none w-full text-warm-white whitestone:text-gray-900"
              />
            </div>
            <div className="flex flex-col gap-3">
              <label className="text-[16px] text-golden-300 whitestone:text-blue-700 whitestone:font-semibold">
            ...
            <div>
              <button
                type="button"
                className="bg-gold-gradient whitestone:bg-blue-600 btn-hover flex justify-center w-full py-2 rounded-md text-warm-white whitestone:text-white font-semibold text-xl transition-all duration-300 border-2 border-golden-400 whitestone:border-blue-700 shadow-lg"
            ...
            <div>
              <button
                type="button"
                className="bg-burgundy-gradient whitestone:bg-blue-600 btn-hover flex justify-center w-full py-2 rounded-md text-warm-white whitestone:text-white font-semibold text-xl transition-all duration-300 border-2 border-golden-400 whitestone:border-blue-500 shadow-lg"
