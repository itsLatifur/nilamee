    ...
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div className="bg-luxury-gradient rounded-lg p-8 shadow-xl border-4 border-golden-400 whitestone:border-white/30 dark:border-golden-500 whitestone:border-white/40 relative overflow-hidden">
          ...
          <h1
            className={`text-white whitestone:text-black whitestone:text-white text-2xl font-bold mb-4 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl flex items-center gap-4`}
          >
            <span className="text-golden-300 whitestone:text-gray-900">?</span>
            About Us
          </h1>
          <p className="text-golden-100 whitestone:text-gray-700 text-lg md:text-xl">
        ...
        <div>
          <div className="bg-luxury-gradient rounded-lg p-4 mb-4 shadow-lg border-2 border-golden-400 whitestone:border-white/30 dark:border-golden-500 whitestone:border-white/40">
            <h3
              className={`text-white whitestone:text-black text-xl font-bold mb-1 min-[480px]:text-xl md:text-2xl lg:text-3xl flex items-center gap-2`}
            >
              <span className="text-golden-300 whitestone:text-gray-900">??</span>
              Our Mission
            </h3>
