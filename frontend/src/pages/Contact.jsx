    ...
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-start">
        <div className="bg-gradient-to-br from-burgundy-950/20 to-golden-950/10 dark:from-black/20 dark:to-gray-950/10 backdrop-blur-sm mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md border-4 border-golden-400 shadow-2xl">
          <div className="bg-luxury-gradient rounded-lg p-4 w-full shadow-lg border-2 border-golden-400 dark:border-golden-500 relative overflow-hidden">
            ...
            >
              <span className="text-golden-300">✉️</span>
              Contact Us
            </h3>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full mt-1 p-2 border-b-2 border-b-golden-400 bg-transparent rounded-md focus:outline-none focus:border-b-golden-300 text-warm-white transition-all"
                required
              />
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="w-full mt-1 p-2 border-2 border-golden-400 bg-transparent rounded-md focus:outline-none focus:border-golden-300 text-warm-white transition-all"
                required
              />
            </div>

            <button
              className="bg-burgundy-gradient mx-auto font-semibold text-xl transition-all duration-300 py-2 px-4 rounded-md text-warm-white my-4 border-2 border-golden-400 shadow-lg btn-hover"
              type="submit"
            >
