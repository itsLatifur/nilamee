...
const Card = ({ imgSrc, title, startingBid, startTime, endTime, id }) => {
  ...
  return (
    <>
      <Link
        to={`/auction/item/${id}`}
        className="flex-grow basis-full bg-gradient-to-br from-burgundy-950/10 to-golden-950/5 dark:from-black/10 dark:to-gray-950/5 whitestone:bg-white/35 dark:backdrop-blur-sm whitestone:backdrop-blur-xl rounded-md group sm:basis-[280px] md:basis-[280px] lg:basis-[280px] xl:basis-[280px] 2xl:basis-[280px] border-2 border-golden-400 dark:border-golden-500 whitestone:border-white/30 hover:border-burgundy-400 dark:hover:border-gray-600 whitestone:hover:border-blue-300 transition-all duration-300 card-hover relative overflow-hidden"
      >
