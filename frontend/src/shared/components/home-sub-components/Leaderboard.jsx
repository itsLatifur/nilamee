    ...
    <>
      <section className="my-8 lg:px-5">
        <div className="flex flex-col min-[340px]:flex-row min-[340px]:gap-2">
          ...
          <h3 className="text-golden-500 text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
            Bidders Leaderboard
          </h3>
        </div>
        ...
        <Link
          to={"/leaderboard"}
          className="border-2 border-golden-300 dark:border-golden-500 font-bold text-xl w-full py-2 flex justify-center rounded-md text-warm-white hover:border-golden-600 hover:bg-gold-gradient transition-all duration-300 btn-hover-no-scale"
        >
          Go to Leaderboard
        </Link>
      </section>
