            ...
            {auctionsStartingToday.slice(0, 2).map((element) => {
              return (
                <Link
                  ...
                  key={element._id}
                  className="w-full flex flex-col gap-4 bg-white dark:bg-gray-900 p-2 rounded-md 2xl:gap-2 hover:shadow-md transition-all duration-300"
                >
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <p className="font-extralight text-warm-white text-[12px]">
                      {element.title}
                    </p>
                  </div>
