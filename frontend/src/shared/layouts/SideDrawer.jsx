...
import { logout } from "../../features/auth/store/userSlice";
        ...
        <div>
          ...
          <div className="flex gap-2 items-center mb-2">
            <a
              ...
              className="bg-white dark:bg-gray-900 text-golden-600 p-2 text-xl rounded-sm transition-colors"
            >
              <FaFacebook />
            </a>
            <a
          ...
          <Link
            to={"/contact"}
            className="text-golden-400 font-semibold transition-all duration-150"
          >
            Contact Us
          </Link>
          <p className="text-golden-400">&copy; {appConfig.companyName}</p>
          <p className="text-golden-400">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-semibold text-golden-300"
            >
